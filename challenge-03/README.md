...
*/
pessoa.nomeCompleto(); /* Olá! Meu nome é Thaigon Aguiar!
...
pessoa.apresentacao = function(){
    ...
    if(pessoa.idade!=1){
        var idadesingular= 'anos';
    } else if(pessoa.idade=1){
        var idadesingular= 'ano';
    }
	
	if(pessoa.caminhouQuantosMetros!=1){
		var caminhops='metros';
    } else if(pessoa.caminhouQuantosMetros=1){
		var caminhops='metro';
    }
    
    return 'Olá, eu sou ' + artigo + ' ' + pessoa.nome + ' ' + pessoa.sobrenome + ', tenho ' + pessoa.idade + ' ' + idadesingular + ', ' + pessoa.altura + 'm ,' + ' meu peso é ' + pessoa.peso + ' e, só hoje, eu já caminhei ' + pessoa.caminhouQuantosMetros + ' ' + caminhops + '.' ;
